...
class CustomerCMDSView extends StatefulWidget {
  const CustomerCMDSView({super.key});

  @override
  State<CustomerCMDSView> createState() => _CustomerCMDSViewState();
}

class _CustomerCMDSViewState extends State<CustomerCMDSView> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      if (cnt.loaded.value) {
        cnt.getCustomerHasCmd.listen((event) {
          cnt.customersHasCmd.value = event;
        });
        return StreamBuilder<List<Customer>>(
            stream: cnt.getCustomerHasCmd,
            initialData: [],
            builder: (context, snapshot) {
              if (snapshot.hasError) {
                ...
                cnt.ligneCmdS.clear();
                for (var el in cnt.customersHasCmd) {
                            ...
                            onShowDetail: (cus) {
                              showDialog(
                                  ...
                                  builder: (_) => Dialog(
                                        ...
                                        pageController: cnt.cntPage.value,
                                        initialPage: cnt.indexPage.value,
                                        pageSteps: [
                                          PageStep(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Div(
                                                                                divison: const Division(colS: 12, colM: 6, colL: 6),
                                                                                child: Text(cus.cartData![index].key!)),
                                                                            Div(
                                                                      ...
                                                                      children: List.generate(
                                                                        ...
                                                                        return Row(
                                                                          children: [
                                                                            ...
                                                                            Text(y[i].product!.isSale! ? ' ${DataConverter.currencyConvert(y[i].product!.sPrice!.toDouble())}' : ' ${DataConverter.currencyConvert(y[i].product!.nPrice!.toDouble())}',
                                                                                style: const TextStyle(
                                                                                  fontSize: 14,
                                                                                )),
                                                                            Expanded(
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: ElevatedButton(
                                                            ...
                                                            child: Text(
                                                                "تاريخ التسليم   ${DateFormat('dd MMM yyy', 'ar_MA').format(cnt.dilevryDate.value)}")),
                                                      ),
                                                      Padding(
                                                        padding:
                                                            const EdgeInsets
                                                                .all(8.0),
                                                        child: Text(
                                                            'مرجع الطلبية ${cnt.confirmCMD.value.key}'),
                                                      ),
                                                      Padding(
                                                        padding:
                                                            const EdgeInsets
                                                                .all(8.0),
                                                        child: Text(
                                                            'المجموع  ${DataConverter.currencyConvert(cnt.cartProducts(cnt.confirmCMD.value.cart!).sumTotal((element) => element.product!.isSale! ? element.qte! * element.product!.sPrice! : element.qte! * element.product!.nPrice!).toDouble())}'),
                                                      ),
                                                    ],
                                                  ),
                                                ),
