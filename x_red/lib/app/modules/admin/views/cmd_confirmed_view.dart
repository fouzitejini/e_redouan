...
class CustomerCMDSConfirmedView extends StatefulWidget {
  const CustomerCMDSConfirmedView({super.key});

  @override
  State<CustomerCMDSConfirmedView> createState() =>
      _CustomerCMDSConfirmedViewState();
}

class _CustomerCMDSConfirmedViewState extends State<CustomerCMDSConfirmedView> {
